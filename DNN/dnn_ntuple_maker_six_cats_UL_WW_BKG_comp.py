...
OUTFILE = uproot3.recreate("/eos/user/j/jrotter/HWW_DNN_Ntuples/HWW_DNN_Ntuple_WW_BKG_COMP.root")
# FILE VERSIONING:
...
CONFIG_FILE_PATH = "WW_BKG_COMP_dnn_config.json"
        ...
        for subcat_i in range(0,len(CONFIG[category]["subpaths"])):
            ...
            for f in files:
                ...
                try:
                    ...
                    print("One or more masks were empty...")
                    continue
